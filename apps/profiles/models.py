...
class Profile(TimeStampedUUIDModel):
    ...
    city = models.CharField(
        verbose_name=_("City"),max_length=180,
        default="Moscow",blank=True,null=False)
    is_buyer = models.BooleanField(
        verbose_name=_("Bayer"),default=False,
        help_text=_("Are you looking to Buy a Property"))
    is_seller = models.BooleanField(
        verbose_name=_("Seller"),default=False,
        help_text=_("Are you looking to sell a Property"))
    is_agent = models.BooleanField(
        verbose_name=_("Agent"),default=False,
        help_text=_("Are you an agent?"))
    top_agent = models.BooleanField(
        verbose_name=_("Top agent"),default=False)
